...
namespace BuyPatrols
{
    public class Settings : AttributeSettings<Settings>
    {
        ...
        */
        ...
        [SettingProperty("AI Patrol Hiring Chance", 1, 100, false, hintText: "The daily chance that another lord will hire a patrol per village.")]
        [SettingPropertyGroup("Ai Hiring Settings")]
        public int AiGenerationChance { get; set; } = 10;

        
        [SettingProperty("AI Patrol Bonus Speed", 0, 10, false, hintText: "The bonus speed that will be added to AI hired patrols.")]
        [SettingPropertyGroup("Ai Hiring Settings")]
